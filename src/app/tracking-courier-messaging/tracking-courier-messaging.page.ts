...
@Component({
  selector: 'app-tracking-courier-messaging',
  templateUrl: './tracking-courier-messaging.page.html',
  styleUrls: ['./tracking-courier-messaging.page.scss'],
})
export class TrackingCourierMessagingPage implements OnInit {
  request: Request;
  courier: Courier;
  newMap: GoogleMap;
