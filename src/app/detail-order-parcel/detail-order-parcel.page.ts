...
@Component({
  selector: 'app-detail-order-parcel',
  templateUrl: './detail-order-parcel.page.html',
  styleUrls: ['./detail-order-parcel.page.scss'],
})
export class DetailOrderParcelPage implements OnInit {
